#!/usr/bin/env python3
"""
train_eegnet_ds006036.py

Train EEGNet on:
  <fyp_root>/data/ds006036_preprocessed_shards/{train,eval}

If your actual folder is different, for example ds006036_eval_shards,
change --data_dir when you run the script.

Outputs:
  logs   -> <fyp_root>/experiments/logs/train_eegnet_ds006036.log
  model  -> <fyp_root>/models/train_eegnet_ds006036.pt
  metrics-> <fyp_root>/experiments/train_eegnet_ds006036/metrics.json
"""
...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="data/ds006036_preprocessed_shards")
    ...
    run_name = "train_eegnet_ds006036"
